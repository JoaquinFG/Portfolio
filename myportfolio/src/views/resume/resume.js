          ...
          <div className="row">
            <div className="col-lg-4 col-sm-12">
              ...
              <p className="font-italic">
                ...
                incorporación de nuevos conocimientos en este sector me han
                hecho capaz de alcanzar el título de Técnico en Desarrollo de
                Aplicaciones Multiplataformas, además de preparar mi mente para
                absorver nuevas tecnologías de una manera muy eficaz, logrando
                así numerosos certificados de diferentes plataformas online como
                son Platzi y OpenWebinars.
              </p>
              {/* <p>
